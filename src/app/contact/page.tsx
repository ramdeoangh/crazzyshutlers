...
export const metadata: Metadata = {
  title: "Contact",
  description: `Get in touch with ${appConfig.name}. Reach out via email, phone, or social media.`,
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <Card variant="elevated" className="text-center">
            ...
            <a
              href={`tel:${appConfig.social.phone.replace(/\s/g, "")}`}
              className="text-primary-600 hover:text-primary-700 font-medium"
            >
              {appConfig.social.phone}
            </a>
          </Card>
        </div>
        ...
        <Card variant="elevated">
          ...
          <p className="text-gray-700 mb-6">
            Stay connected with us on social media for updates, announcements,
